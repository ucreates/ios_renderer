...
@interface ObjAsset ()
@end
@implementation ObjAsset
- (id)init {
    self = [super init];
    self->_vertex = [[VertexArray alloc] init:kDimension3D];
    self->_subMeshes = [[NSMutableArray<Mesh*> alloc] init];
    return self;
}
- (void)create:(NSString*)objPath {
    ...
    NSMutableArray<NSNumber*>* vertexArray = [[NSMutableArray<NSNumber*> alloc] init];
      ...
      if (1 < data.count) {
          ...
          if (false != [command isEqualToString:@"g"]) {
              ...
              if (false != [name isEqualToString:@"default"]) {
                  [self addSubMesh:mesh vertexArray:vertexArray colorArray:colorArray normalArray:normalArray uvArray:uvArray vertexCount:vertexCount];
                  vertexCount = 0;
              ...
              MaterialAsset* materialAsset = [[MaterialAsset alloc] init];
              ...
              NSMutableArray<NSNumber*>* tmpVertexArray = [[NSMutableArray<NSNumber*> alloc] init];
              ...
              for (int i = 1; i < data.count; i++) {
                  ...
                  [tmpVertexArray addObject:vertex];
                  [tmpUvArray addObject:uv];
                  [tmpNormalArray addObject:normal];
              }
              if (3 == tmpVertexArray.count) {
                  NSNumber* t1 = [tmpVertexArray objectAtIndex:0];
                  NSNumber* t2 = [tmpVertexArray objectAtIndex:1];
                  NSNumber* t3 = [tmpVertexArray objectAtIndex:2];
                  ...
                  [vertexArray addObject:x1];
                  [vertexArray addObject:y1];
                  [vertexArray addObject:z1];
                  [vertexArray addObject:x2];
                  [vertexArray addObject:y2];
                  [vertexArray addObject:z2];
                  [vertexArray addObject:x3];
                  [vertexArray addObject:y3];
                  [vertexArray addObject:z3];
                  int count = 3 * kRGBA;
                  ...
                  vertexCount += 3;
              } else if (4 == tmpVertexArray.count) {
                  NSNumber* t1 = [tmpVertexArray objectAtIndex:0];
                  NSNumber* t2 = [tmpVertexArray objectAtIndex:1];
                  NSNumber* t3 = [tmpVertexArray objectAtIndex:2];
                  NSNumber* t4 = [tmpVertexArray objectAtIndex:3];
                  int tidx1 = [t1 intValue] - 1;
                  int tidx2 = [t2 intValue] - 1;
                  int tidx3 = [t3 intValue] - 1;
                  ...
                  [vertexArray addObject:y2];
                  [vertexArray addObject:z2];
                  [vertexArray addObject:x4];
                  [vertexArray addObject:y4];
                  [vertexArray addObject:z4];
                  [vertexArray addObject:x4];
                  [vertexArray addObject:y4];
                  [vertexArray addObject:z4];
                  [vertexArray addObject:x2];
...
- (void)addSubMesh:(Mesh*)mesh vertexArray:(NSMutableArray*)vertexArray colorArray:(NSMutableArray*)colorArray normalArray:(NSMutableArray*)normalArray uvArray:(NSMutableArray*)uvArray vertexCount:(int)vertexCount {
    if (nil == mesh) {
        return;
    }
    VertexArray* vertex = [[VertexArray alloc] init:kDimension3D];
    ...
    if (nil != self->_materials) {
        Material* material = [self->_materials objectForKey:mesh.useMaterial];
        if (nil != material) {
