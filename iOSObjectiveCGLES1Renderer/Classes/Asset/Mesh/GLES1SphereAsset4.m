...
// ======================================================================
#import "GLES1SphereAsset4.h"
#import "GLES1Angle.h"
#import "GLES1Normal.h"
#import "GLES1Renderer.h"
@interface GLES1SphereAsset4 ()
@end
@implementation GLES1SphereAsset4
...
- (void)create {
    int vertexCount = self->_divideCount * self->_divideCount;
    ...
    int indiciesLength = (self->_divideCount - 1) * self->_divideCount * 4;
...
- (void)create:(NSString*)texturePath {
    ...
    for (int i = 0; i < self->_divideCount; i++) {
        ...
        for (int j = 0; j < self->_divideCount; j++) {
            ...
            GLfloat x = cosf(uradian) * r;
            GLfloat z = sinf(uradian) * r;
            GLfloat v1ratio = self->_texture.uvRatio.width;
