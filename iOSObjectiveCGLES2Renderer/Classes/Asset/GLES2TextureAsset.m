...
#import "GLES2Exponentiation.h"
#import "GLES2Renderer.h"
@implementation GLES2TextureAsset
- (id)init {
...
- (void)setTextureUnit:(NSString*)textureUnitName textureNum:(int)textureNum {
    self->_textureUnitName = textureUnitName;
    self->_textureNumber = textureNum;
    return;
}
...
- (NSString*)textureUnitName {
    return self->_textureUnitName;
}
- (GLuint)textureNumber {
    return self->_textureNumber;
}
- (CGSize)size {
    return self->_size;
}
